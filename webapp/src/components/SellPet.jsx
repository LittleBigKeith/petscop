...
const createPet = (props) => {
    ...
    const endpointPostOwnerPet = BASE_URL + "ownerpet/create"
...
function SimpleDialog(props) {
    ...
    return (
        <Dialog className="nickname-dialog" onClose={handleCloseDialog} open={openDialog}>
            ...
            <form className="nickname-form" onSubmit={(e) => {e.preventDefault(); createPet(props); onClose(); setOpenSnackbar(true)}}>
                <TextField label="nickname" onChange={e => setNickname(e.target.value)}></TextField>
                <br />
